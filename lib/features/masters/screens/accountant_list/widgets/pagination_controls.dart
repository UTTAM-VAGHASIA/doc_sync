...
class PaginationControls extends StatelessWidget {
  final AccountantListController controller;
          ...
          children: [
            ...
            Obx(() {
              final start =
                  ...
                  (controller.filteredAccountants.isEmpty ? 0 : 1);
              final end = start + controller.paginatedAccountants.length - 
                  (controller.filteredAccountants.isEmpty ? 0 : 1);
              final total = controller.filteredAccountants.length;

              return Padding(
                padding: const EdgeInsets.only(top: 8.0),
                child: Text(
                  controller.filteredAccountants.isEmpty 
                      ? 'No entries to show' 

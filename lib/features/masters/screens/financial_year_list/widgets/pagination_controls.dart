...
class PaginationControls extends StatelessWidget {
  final FinancialYearListController controller;
          ...
          children: [
            ...
            Obx(() {
              final start =
                  ...
                  (controller.filteredFinancialYears.isEmpty ? 0 : 1);
              final end = start + controller.paginatedFinancialYears.length - 
                  (controller.filteredFinancialYears.isEmpty ? 0 : 1);
              final total = controller.filteredFinancialYears.length;

              return Padding(
                padding: const EdgeInsets.only(top: 8.0),
                child: Text(
                  controller.filteredFinancialYears.isEmpty 
                      ? 'No entries to show' 
  ...
  Widget _buildSingleArrowButton({
    ...
    return Tooltip(
      ...
      child: Container(
        ...
        child: Material(
          color: isEnabled ? AppColors.primary.withOpacity(0.1) : Colors.grey.shade100,
          borderRadius: BorderRadius.circular(8),
          child: InkWell(
            borderRadius: BorderRadius.circular(8),

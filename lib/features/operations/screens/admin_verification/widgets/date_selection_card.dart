...
class DateSelectionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        onTap: () => _selectDate(Get.context!, adminVerificationController),
        borderRadius: BorderRadius.circular(12),
        child: Container(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Obx(
                          () => Text(
                            adminVerificationController.filterTaskDateStr.value.isEmpty
                                ? "No date selected"
                                : DateFormat("dd MMM, yyyy").format(
                                  DateTime.parse(
                                    adminVerificationController.filterTaskDateStr.value,
                                  ),
                                ),
                            style: Theme.of(
                              context,

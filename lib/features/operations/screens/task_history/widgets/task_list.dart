...
import 'package:doc_sync/features/operations/screens/task_history/widgets/task_card.dart';
...
class TaskList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => ListView.builder(
      ...
      itemCount: taskHistoryController.paginatedTasks.length,
      padding: const EdgeInsets.symmetric(horizontal: 16.0),
      itemBuilder: (context, index) {
        final task = taskHistoryController.paginatedTasks[index];
